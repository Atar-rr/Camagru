...
class Validator
{
	...
	private function validateLogin()
	{
		if (empty($this->user['login'])) {
			...
			$this->errors['login']  = "Вы ввели недопустимые символы. Логин может содержать буквы, цифры и символы нижнего подчеркивания";
		} else {
	...
	private function validatePassword()
	{
		if (empty($this->user['password'])) {
			...
			$this->errors['password'] = "Вы ввели недопустимые символы. Пароль должен содержать цифры и буквы латинского алфавита в верхнем и нижнем регистре.";//"Пароль должен содержать не менее восьми знаков, включать заглавную и строчную букву и цифру. ''";
		}
	}
